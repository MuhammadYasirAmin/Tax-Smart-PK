    ...
    <div class="container">
            ...
            <div class="row align-items-end">
                ...
                <div class="col-xl-4 col-lg-5 wow fadeInRight order-1 order-lg-2">
                    <div class="pg-features__thumb">
                        <img src="assets/images/feature/feature-thumb-1.webp" alt="feature thumb 1">
                    </div>
                </div>
            </div>
        </div>
        <div class="pg-features">
            <div class="row align-items-end">
                <div class="col-xl-4 col-lg-5 wow fadeInLeft">
                    <div class="pg-features__thumb">
                        <img src="assets/images/feature/feature-thumb-2.webp" alt="feature thumb 1">
                    </div>
                </div>
        ...
        <div class="pg-features">
            <div class="row align-items-end">
                ...
                <div class="col-xl-4 col-lg-5 wow fadeInRight order-1 order-lg-2">
                    <div class="pg-features__thumb">
                        <img src="assets/images/feature/feature-thumb-3.webp" alt="feature thumb 1">
                    </div>
                </div>
            </div>
        </div>
